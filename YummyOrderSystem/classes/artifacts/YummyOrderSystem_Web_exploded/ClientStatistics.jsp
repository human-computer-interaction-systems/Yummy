...
function show(){
	...
	$.ajax({
		...
		success:function(data){
			...
			var rtype1 = Number(data.myDYXF);
			var rtype2 = Number(data.myDYSJ);
				    ...
				    series: [
				        {
				            ...
				            type:'line',
				            stack: '总量',
				            data:[32.2, 16.5, 18.0, 33.0, 45.1, 38.6, 44.6]
				        },
				        {
				            name:'商店消费',
				            type:'line',
				            stack: '总量',
				            data:[0.0, 6.0, 4.0, 10.0, 8.0, 30.0, 27.0]
				        },
				    ...
				    series: [
				        {
				            ...
				            data:[
				                {value:506.16, name:'餐厅消费'},
				                {value:196.84, name:'商店消费'}
				            ]
				        },
				        {
				            name:'订单数量',
				            ...
				            data:[
				                {value:10, name:'0-20元'},
				                {value:32, name:'20-50元'},
				                {value:9, name:'50-100元'},
				                {value:4, name:'100元以上'}				              
				            ]
				        }
				    ]
			...
			<div class="main-page">
				...
				<div class="chat-grids">
					...
					<div class="col-md-6 chat-grid1">
						<div class="grid-1">
								<h3>历史消费种类统计</h3>
								<div id="chart5" style="width: 530px;height: 235px;"></div>
							</div>
					</div>
					<div class="clearfix"></div>
				</div>
