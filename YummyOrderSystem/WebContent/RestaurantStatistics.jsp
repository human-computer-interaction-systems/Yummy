...
function show(){
	...
	$.ajax({
		...
		success:function(data){
			var ctype1 = Number(data.myDYDD);
			var ctype2 = Number(data.myDYTD);
			var rtype1 = Number(data.myDYJZ);
			var rtype2 = Number(data.myDYGK);
				    ...
				    series: [
				        {
				            ...
				            type:'line',
				            stack: '总量',
				            data:[322, 165, 180, 330, 451, 386, 446]
				        },
				        {
				            name:'下午时段',
				            type:'line',
				            stack: '总量',
				            data:[893, 534, 614, 870, 743, 1184, 1265]
				        },
				        {
				            name:'全天',
				            type:'line',
				            stack: '总量',
				            data:[1215, 699, 794, 1210, 1194, 1570, 1711]
				        }
				    ...
				    color: ['#009CFF', '#FF072F'],  //设置多个颜色值时代表的是图例颜色
				      ...
				      series: [    //对应折线图和柱形图，进行数据加载
				    	  
				        {
				          name: '平均订单价格',
				          type: 'bar',
				          data: [20.3,22.7,24.4,25.0,24.8,26.6],
				          barWidth: '12',
				        },
				        {
				          name: '订单成功率',
				    ...
				    color: ['#009CFF', '#FF072F'],  //设置多个颜色值时代表的是图例颜色
				      ...
				      series: [    //对应折线图和柱形图，进行数据加载
				    	  
				        {
				          name: '平均订单价格指数',
				          type: 'bar',
				          data: [80.2,82.3,80.9,86.4,87.1,92.0],
				          barWidth: '12',
				        },
				        {
				          name: '市场占比',
			...
			option7 = {
				    ...
				    series: [
				        ...
				        },
				        {
				            ...
				            data:[
				                {value:208, name:'8-12时'},
				                {value:320, name:'12-16时'},
				                {value:451, name:'16-20时'},
				                {value:124, name:'20时以后'}				              
				            ]
				        }
				    ]
				};
			...
			option8 = {
				    ...
				    series: [
				        ...
				        },
				        {
				            ...
				            data:[
				                {value:206, name:'20岁以下'},
				                {value:594, name:'20-35岁'},
				                {value:243, name:'35-50岁'},
				                {value:60, name:'50岁以上'}				              
				            ]
				        }
				    ]
				    ...
				    series : [
				        {
				            ...
				            type:'bar',
				            barWidth: '60%',
				            data:[5232, 8023, 10753, 13323, 15230, 14324, 17042,19633,20536,21632,23091,22453]
				        }
				    ]
				};
