...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>RestaurantAddDiscount</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material" action="RestaurantAddDiscountServlet" id="curst" method="post" onsubmit="return check()">                                    
